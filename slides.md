...
- 下キー	下のスライドへ垂直移動
- 上キー	上のスライドへ垂直移動
- space	次のスライドへ垂直＝＞水平の順に移動
- shift + space	前のスライドへ垂直＝＞水平
- Home	最初のスライドへ
- End	最後のスライドへ
- **Esc	概要表示**
...
※感染拡大の抑制、耐性強化を優先するということ。むやみに消費を刺激して感染が拡大してはいけない。
...
![kokushin](https://kokushin-u.jp/wp-content/themes/tpwp_sui/images/1.jpg)

 
- https://kokushin-u.jp/ にアクセスしてみよう。
- 国際信州学院大学は**実在しない**。
- 真偽を見抜くことはできるだろうか？
...
- 精度を上げるには、**事前確率（検査対象に感染者が含まれる割合)** がきわめて重要になる。
  - 医師の所見により検査対象の事前確率を上げる。
- これらは、統計学の基礎知識があれば**専門家でなくても理解できる**。
  - 基礎的な勉強が大事。
- 自分が検査をして陽性だった場合、本当に感染しているだろうか？
  （思い当たる節がなければ、的中率は1%）
...
- 必要な分だけ、必要な人に行き渡る解があるはずなのに、個人の合理的な行動だけでは実現できない
	（**合成の誤謬**）
- 人間はすでに手にした快適さを失うことに対して強く拒絶する傾向がある(**損失回避**)
- 転売問題が事態をややこしくしている。
